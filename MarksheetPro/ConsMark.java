...
class Student
{
	...
	Student(String name,String fname,String mname,String course,String branch,int roll,int year,int sem,int p,int c,int m,int h,int e)
	{
		this.name=name;
		this.fname=fname;
		this.mname=mname;
...
class TestMain
{
	...
	{
		String name,fname,mname,course,branch;
		int roll,year,sem,p,c,m,h,e,total=0;
		double per;

...
import java.io.FileOutputStream;so
...
class Mark
{
	public static void main(String args[])
	{
		try
		{
			Student s=new Student("kapil","dinesh","sampat","Bsc","seed",101,2,3,44,55,54,44,88);
...
class Student implements java.io.Serializable
{
	...
	{
		return "name="+name+"fname"+fname+"mname"+mname+"course"+course+"branch"+branch+"roll"+roll+"yer"+year+"p"+p+"c"+c+"m"+m+"h"+h+"e"+e+"total"+total+"per"+per;
	}
}
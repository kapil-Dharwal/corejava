...
class DymetarOfircle extends Frame implements ActionListener
{   
    Label lb1,lb2;
    TextField tf1;
    Button btn1 ,btn2;
    public DymetarOfircle()
    {
        this.setVisible(true);
        this.setBackground(Color.GRAY);
        this.setLayout(null);
        setTitle("DYMETERCIRCLE");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText("dymetar of circal="+String.valueOf(2*r));
            }
...
class Test
{
    ...
    {
        DymetarOfircle ob = new DymetarOfircle();
    }
}
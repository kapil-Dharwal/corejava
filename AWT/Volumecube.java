...
class VolumeOfcube extends Frame implements ActionListener
{   
    Label lb1,lb2,lb3;
    TextField tf1,tf2;
    Button btn1 ,btn2;
    public VolumeOfcube()
    {
        ...
        this.setLayout(null);
        setTitle("VOLUME OF QUBE");
        this.setBounds(50,50,350,400);
        lb1 = new Label("Enter VolumeOfcube side");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText("VolumeOfcube="+String.valueOf(r*r));
            }
...
class Test
{
    ...
    {
       VolumeOfcube ob = new VolumeOfcube();
    }
}
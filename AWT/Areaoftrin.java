...
class AreaOftringle extends Frame implements ActionListener
{   
    Label lb1,lb2,lb3;
    TextField tf1,tf2;
    Button btn1 ,btn2;
    public AreaOftringle()
    {
        ...
        lb1 = new Label("Enter lenght of tringle");
        lb1.setBounds(20,50,170,30);
        lb1.setBackground(Color.WHITE);
        lb1.setForeground(Color.BLACK);
        this.add(lb1);
		lb3 = new Label("Enter height of tringle");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText(String.valueOf((1*h*r)/2));
            }
...
class Test
{
    ...
    {
       AreaOftringle ob = new AreaOftringle();
    }
}
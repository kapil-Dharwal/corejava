...
class AreaOfrec extends Frame implements ActionListener
{   
    Label lb1,lb2,lb3;
    TextField tf1,tf2;
    Button btn1 ,btn2;
    public AreaOfrec()
    {
        ...
        this.add(lb1);
		lb3 = new Label("Enter height of rectangle");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText(String.valueOf(h*r));
            }

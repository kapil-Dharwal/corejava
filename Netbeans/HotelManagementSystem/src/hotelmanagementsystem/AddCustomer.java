...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(){
        ...
        lbldiposit.setBounds(35,360,100,20);
        lbldiposit.setFont(new Font("Raleway",Font.PLAIN,20));
        add(lbldiposit);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource()== add){
            ...
            try {
                ...
                String query2 = "update room set availability = 'Occupied' where roomnumber = '" + customer +"'";

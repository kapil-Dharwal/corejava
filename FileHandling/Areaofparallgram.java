...
class AreaOfparallegram extends Frame implements ActionListener
{   
    Label lb1,lb2,lb3;
    TextField tf1,tf2;
    Button btn1 ,btn2;
    public AreaOfparallegram()
    {
        this.setVisible(true);
        this.setBackground(Color.GRAY);
        this.setLayout(null);
        setTitle("AREAOFPARAGRAM");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText("AreaOfparallegram="+String.valueOf(h*r));
            }
...
class Test
{
    ...
    {
       AreaOfparallegram ob = new AreaOfparallegram();
    }
}
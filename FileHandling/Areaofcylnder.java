...
class VolumeOfcylinder extends Frame implements ActionListener
{   
    Label lb1,lb2,lb3;
    TextField tf1,tf2;
    Button btn1 ,btn2;
    public VolumeOfcylinder()
    {
        ...
        this.setLayout(null);
        setTitle("VOLUME OF CYLINER");
        this.setBounds(50,50,350,400);
        lb1 = new Label("Enter redius");
        lb1.setBounds(20,50,170,30);
        lb1.setBackground(Color.WHITE);
        lb1.setForeground(Color.BLACK);
        this.add(lb1);
		lb3 = new Label("Enter height ");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText("VolumeOfcylinder="+String.valueOf(3.14*r*r*h));
            }
...
class Test
{
    ...
    {
       VolumeOfcylinder ob = new VolumeOfcylinder();
    }
}
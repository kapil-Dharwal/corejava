...
class VolumeOfsphere extends Frame implements ActionListener
{   
    Label lb1,lb2;
    TextField tf1;
    Button btn1 ,btn2;
    public  VolumeOfsphere()
    {
        ...
        this.setLayout(null);
        setTitle(" VOLUME OF SPHERE");
        this.setBounds(50,50,350,400);
        lb1 = new Label("Enter redius Of VOLUME");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText(" VolumeOfsphere="+String.valueOf((4*3.14*r*r)/3));
            }
...
class Test
{
    ...
    {
       VolumeOfsphere ob = new VolumeOfsphere();
    }
}
...
class perimetarOfparallegram extends Frame implements ActionListener
{   
    Label lb1,lb2,lb3;
    TextField tf1,tf2;
    Button btn1 ,btn2;
    public perimetarOfparallegram()
    {
        this.setVisible(true);
        this.setBackground(Color.GRAY);
        this.setLayout(null);
        setTitle("PERAMETEROFPERALLAGRAM");
        this.setBounds(50,50,350,400);
        lb1 = new Label("Enter lenght of parallegram");
        lb1.setBounds(20,50,170,30);
        lb1.setBackground(Color.WHITE);
        lb1.setForeground(Color.BLACK);
        this.add(lb1);
		lb3 = new Label("Enter widht of parallegram");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText("perimetarOfparallegram="+String.valueOf((h+r)*2));
            }
...
class Test
{
    ...
    {
       perimetarOfparallegram ob = new perimetarOfparallegram();
    }
}
...
class PeriOfsqure extends Frame implements ActionListener
{   
    Label lb1,lb2;
    TextField tf1;
    Button btn1 ,btn2;
    public PeriOfsqure()
    {
        ...
        lb1 = new Label("Enter The side of squre");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==btn1)
        {
            try 
            {
                ...
                lb2.setText("perimetar  of squre="+String.valueOf(r+r+r+r));
            }
...
class Test
{
    ...
    {
       PeriOfsqure ob = new PeriOfsqure();
    }
}